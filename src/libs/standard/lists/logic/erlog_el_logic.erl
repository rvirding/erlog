...
insert(Params = #param{goal = {insert, A1, A2, A3}, next_goal = Next, bindings = Bs, choice = Cps, var_num = Vn, f_consulter = Fcon}) ->
	FailFun = fun(LCp, LCps, LDb) ->  %TODO db not needed
		erlog_el_logic:fail_insert(LCp, Params#param{choice = LCps, database = LDb, f_consulter = Fcon}, A1, A2, A3)
	end,
